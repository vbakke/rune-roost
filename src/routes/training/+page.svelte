<script lang="ts">
	...
	let symmetricKey = new SecretKey(alphabet);
	let asymmetricCert = new AsymCaesarRotCertificate(alphabet);
	while (symmetricKey.key.plain === asymmetricCert.publicKey.plain) {
		symmetricKey.generateKey();
	}

	// 5. Selectable encryption algorithms (stateless)
